...
class MainActivity : AppCompatActivity() {
    ...
    private fun isiGambar(txtHello: TextView, image1: ImageView){
        ...
        when (tes) {
            1 -> image1.setImageDrawable(getDrawable(R.drawable.anime1))
            2 -> image1.setImageDrawable(getDrawable(R.drawable.anime2))
            3 -> image1.setImageDrawable(getDrawable(R.drawable.anime3))
            4 -> image1.setImageDrawable(getDrawable(R.drawable.anime4))
            5 -> image1.setImageDrawable(getDrawable(R.drawable.anime5
            ))
            else -> { // Note the block
                image1.setImageDrawable(getDrawable(R.drawable.anime2))
            }
        }
    }
